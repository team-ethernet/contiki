...
UNIT_TEST(cbor_noise_sensor){
  ...
  END_SENML();
	char str[] = {0x9F, 0xBF, 0x21, 0x78, 0x18, 0x75, 0x72, 0x6E, 0x3A, 0x6D, 0x61, 0x63, 0x3A, 0x66, 0x63, 0x63, 0x32, 0x39, 0x34, 0x38, 0x33, 0x37, 0x35, 0x30, 0x32, 0x38, 0x35, 0x37, 0x33, 0x01, 0x62, 0x64, 0x42, 0x02, 0xFB, 0x40, 0x4D, 0x9D, 0x70, 0xA3, 0xD7, 0x0A, 0x3D, 0xFF, 0xFF};
...
UNIT_TEST(cbor_many_parameters) {
  ...
  END_SENML();
	...
	char str[] = {0x9F, 0xBF, 0x20, 0x05, 0x01, 0x63, 0x6D, 0x2F, 0x73, 0x02, 0xFB, 0x40, 0x29, 0x37, 0xB0, 0x0B, 0xCB, 0xE6, 0x1D, 0xFF, 0xFF};
